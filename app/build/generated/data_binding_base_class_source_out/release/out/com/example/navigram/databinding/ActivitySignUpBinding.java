...
public final class ActivitySignUpBinding implements ViewBinding {
  ...
  private ActivitySignUpBinding(@NonNull ConstraintLayout rootView,
      @NonNull EditText confirmPassword, @NonNull EditText email, @NonNull ImageView imageView,
      @NonNull ProgressBar loading, @NonNull Button login, @NonNull ImageButton loginWithGoogle,
      @NonNull ConstraintLayout main, @NonNull EditText password, @NonNull Button signUp,
  ...
  public static ActivitySignUpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySignUpBinding((ConstraintLayout) rootView, confirmPassword, email,
          imageView, loading, login, loginWithGoogle, main, password, signUp, textView, textView2,
          textView5, username);
    }
