...
public final class ActivityGalleryBinding implements ViewBinding {
  ...
  private ActivityGalleryBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar,
  ...
  public static ActivityGalleryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGalleryBinding((LinearLayout) rootView, progressBar, recyclerView);
    }
