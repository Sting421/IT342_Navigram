...
public final class ItemCommentBinding implements ViewBinding {
  ...
  private ItemCommentBinding(@NonNull ConstraintLayout rootView,
      @NonNull ShapeableImageView imageViewProfile, @NonNull TextView textViewComment,
      @NonNull TextView textViewTimestamp, @NonNull TextView textViewUsername) {
  ...
  public static ItemCommentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCommentBinding((ConstraintLayout) rootView, imageViewProfile, textViewComment,
          textViewTimestamp, textViewUsername);
    }
