...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  private FragmentDashboardBinding(@NonNull CoordinatorLayout rootView,
      @NonNull FloatingActionButton fabAddPost, @NonNull RecyclerView feedRecyclerView,
      @NonNull RecyclerView storiesRecyclerView, @NonNull Toolbar toolbar) {
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDashboardBinding((CoordinatorLayout) rootView, fabAddPost,
          feedRecyclerView, storiesRecyclerView, toolbar);
    }
