...
public final class ItemStoryBinding implements ViewBinding {
  ...
  private ItemStoryBinding(@NonNull LinearLayout rootView, @NonNull ShapeableImageView storyImage,
      @NonNull TextView storyUsername) {
  ...
  public static ItemStoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemStoryBinding((LinearLayout) rootView, storyImage, storyUsername);
    }
